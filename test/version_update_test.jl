...
@test simulation.model.gh.h == example_output["h"]
@test simulation.model.gu.u == example_output["u"]
@test simulation.model.gv.v == example_output["v"]
@test simulation.model.gh.ηav == example_output["viscosity"]
@test simulation.model.gh.grounded_fraction == example_output["grounded_fraction"]
@test simulation.model.gh.bed_speed ==  example_output["bed_speed"]
println("All tests passed: current branch agrees exactly with original velocity solve")
