...
Construct a WAVI.jl UWavelets structure with size (Nx,Ny)
UWavelets stores wavelet matrix and associated fields for velocities in x direction

Keyword arguments
=================
    - 'Nx': (required) Number of grid cells in x-direction in UWavelts 
    - 'Ny': (required) Number of grid cells in y-direction in UWavelets 
